...
public class Calculate{
    ...
    */
    ...
    public static JavaDoubleRDD multiply(JavaDoubleRDD a, double b){
        return a.mapToDouble(x -> x * b);
    }

    public static JavaDoubleRDD multiply(JavaDoubleRDD a, JavaDoubleRDD b){
        JavaPairRDD<Double, Double> t = a.zip(b);
        return t.mapToDouble(x -> x._1 * x._2);
    }
}